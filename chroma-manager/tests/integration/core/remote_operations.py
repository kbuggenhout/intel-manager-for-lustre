...
class RealRemoteOperations(RemoteOperations):
    ...
    def yum_update(self, server):
        result = self._ssh_address(server['address'], "date; /etc/yum.repos.d/Intel-Lustre-Agent.repo; cat /etc/yum.repos.d/Intel-Lustre-Agent.repo; dnf repolist; dnf check-update; dnf -y update")
